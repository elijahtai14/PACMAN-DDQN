...
EPS_MIN = 0.1
EPS_DECAY = 1_000_000
TARGET_UPDATE = 400  # here, Elijah changed from 8_000
REPLAY_MEMORY_SIZE = 3 * 1200 #here, Elijah changed from 3 * 6000 to 3 * 1500
...
# Algorithm constant 
MAX_FRAMES = 20_000 #Elijah changed from 2,000,000
SAVE_MODEL = 5 # Elijah changed from 20
